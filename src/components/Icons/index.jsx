...
// eslint-disable-next-line react/prop-types
export const MailBox_Icon = ({ width = "32px", height = "32px", className }) => {
    return <>
        <svg className={className}
            width={width}
            height={height}
