...
const Header = () => {
    ...
    return <>
        <header className="h-[60px] w-full shadow-[0_1px_1px_rgba(0,0,0,0.3)] flex justify-center">
            <div className="content h-full w-[1400px] flex items-center justify-between ">
                {/* Logo */}
                <div className="logo ">
                    ...
                    <Menu items={currentUser ? (userMenu) : (MENU_ICON)} >
                        {currentUser ? (
                            <p>
                                ...
                                <Image className={cx("btn-avatar")} src="https://p16-sign-va.tiktokcdn.com/tos-useast2a-avt-0068-giso/30b21814b145eefae57b6a8a8aeaee37~c5_100x100.jpeg?x-expires=1683111600&x-signature=zd9BVUgM3jTSrCwaKRMMK%2BdHTvk%3D" alt="" />
                            </p>
                        ) : (
