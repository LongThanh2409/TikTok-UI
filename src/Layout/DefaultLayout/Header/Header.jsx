...
import { MessageIcon, MailBox_Icon } from '../../../components/Icons';
...
const Header = () => {
    ...
    const userMenu = [
        ...
        {
            icon: <FontAwesomeIcon icon={faCircleDollarToSlot} bounce />,
            title: "Nhận Xu",
            to: "/login"
        },
        {
            icon: <FontAwesomeIcon icon={faGear} style={{ "--fa-primary-color": "#f4f5f5", "--fa-secondary-color": "#3a7e7e", }} />,
            title: "Cài đặt",
            to: "/login"
        },
    ...
    return <>
        <header className="h-[60px] w-full shadow-[0_1px_1px_rgba(0,0,0,0.3)] flex justify-center">
            <div className="content max-w-full  h-full w-[1400px] flex items-center justify-between ">
                {/* Logo */}
                ...
                <div className={cx("action")}>
                    {currentUser ? (
                        ...
                        <div className={cx("current-user, flex")}>
                            ...
                            <Tippy className={cx("tippy-box")} content="Hộp thư" delay={[0, 50]} placement='bottom'>
                                <button className={cx("btn-action")}>
                                    <MailBox_Icon />
                                </button>
                            </Tippy>
                    ...
                    <Menu items={currentUser ? (userMenu) : (MENU_ICON)} >
                        {currentUser ? (
                            <p>

                                <Image className={cx("btn-avatar")} src="https://icdn.dantri.com.vn/thumb_w/640/2020/12/16/ngam-dan-hot-girl-xinh-dep-noi-bat-nhat-nam-2020-docx-1608126694049.jpeg" alt="" />
                            </p>
                        ) : (
